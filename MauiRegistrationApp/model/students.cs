...
namespace MauiRegistrationApp.Model
{
    using System;
    ...
    public partial class CurrentSemester
{
    ...
    public partial class User
    {
        public static User FromJson(string json) => JsonConvert.DeserializeObject<User>(json, MauiRegistrationApp.Model.Converter.Settings);
        public static List<User> FromJsonList(string json) => JsonConvert.DeserializeObject<List<User>>(json, MauiRegistrationApp.Model.Converter.Settings);

    }

    public static class Serialize
    {
        public static string ToJson(this User self) => JsonConvert.SerializeObject(self, MauiRegistrationApp.Model.Converter.Settings);
    }
